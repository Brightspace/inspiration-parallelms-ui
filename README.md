...
```shell
    npm i
```
Lastly, run the app at `http://127.0.0.1:8081`
```shell
    polymer serve
```
...
To preview the production build, replace `build-folder-name` with the folder name of the build you want to serve.
